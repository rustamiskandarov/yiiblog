        ...
        <div class="container">
            <div class="menu-content">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/"><img src="/public/images/loffgo.jpg" alt="">
                    <?= Yii::$app->name?>
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav text-uppercase">
                        ...
                        <li><a data-toggle="dropdown" class="dropdown-toggle" href="<?= Url::toRoute(['/site/about'])?>">О нас</a>
                        </li>
                    </ul>
                    <div class="i_con">
                        <ul class="nav navbar-nav text-uppercase">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">
                        <p class="pull-left">&copy;<a href="#">My Company</a>  <?= date('Y') ?></p>
                    </div>
                </div>
            </div>
        </div>
